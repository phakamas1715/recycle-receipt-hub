...
const PurchaseForm = () => {
  ...
  const departments: Department[] = [
    { id: "1", name: "แผนกอายุรกรรม" },
    { id: "2", name: "แผนกศัลยกรรม" },
    { id: "3", name: "แผนกกุมารเวชกรรม" },
    { id: "4", name: "แผนกสูติ-นรีเวชกรรม" },
    { id: "5", name: "แผนกเภสัชกรรม" },
    { id: "6", name: "แผนกพยาบาล" },
    { id: "7", name: "แผนกการเงิน" },
    { id: "8", name: "แผนกประชาสัมพันธ์" },
  ];
